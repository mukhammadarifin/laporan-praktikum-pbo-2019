...
public class FrmAnggota1841720128Arifin extends javax.swing.JFrame {
    ...
    public void tampilkanDataArifin() {
        ...
        ArrayList<Anggota1841720128Arifin> list = new Anggota1841720128Arifin().getAll();
        Object rowData[] = new Object[4];

        this.tabelData.setModel(new DefaultTableModel(new Object[][]{}, kolom));
        for (Anggota1841720128Arifin ang : list) {
            rowData[0] = ang.getIdanggotaArifin();
            rowData[1] = ang.getNamaArifin();
            rowData[2] = ang.getAlamatArifin();
            rowData[3] = ang.getTeleponArifin();
    ...
    public void cariArifin(String keyword) {
        ...
        ArrayList<Anggota1841720128Arifin> list = new Anggota1841720128Arifin().search(keyword);
        Object rowData[] = new Object[4];
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        Anggota1841720128Arifin ang = new Anggota1841720128Arifin();
        ang.setIdanggotaArifin(Integer.parseInt(this.id.getText()));
        ang.setNamaArifin(this.nama.getText());
        ang.setAlamatArifin(this.alamat.getText());
        ang.setTeleponArifin(this.telp.getText());
        ang.delete();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        ang.setTeleponArifin(this.telp.getText());
        ang.save();
        this.id.setText(Integer.toString(ang.getIdanggotaArifin()));
        tampilkanDataArifin();
