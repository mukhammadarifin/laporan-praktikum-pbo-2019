...
public class FrmPeminjaman1841720128Arifin extends javax.swing.JFrame {

    /**
     * Creates new form FrmPeminjaman
     */
    public FrmPeminjaman1841720128Arifin() {
        initComponents();
        tampilkanDataArifin();
        kosongkanFormArifin();
    }
    ...
    public void tampilkanDataArifin(){
        ...
        ArrayList<Peminjaman1841720128Arifin> list = new Peminjaman1841720128Arifin().getAllArifin();
        Object rowData[] = new Object[5];
        
        tblPeminjaman.setModel(new DefaultTableModel(new Object[][] {}, kolom));
        
        for (int i = 0; i < list.size(); i++) {
            rowData[0] = list.get(i).getIdpeminjamanArifin();
            rowData[1] = list.get(i).getAnggotaArifin().getNamaArifin();
            rowData[2] = list.get(i).getBukuArifin().getJudulArifin();
            rowData[3] = list.get(i).getTanggalpinjamArifin();
            rowData[4] = list.get(i).getTanggalkembaliArifin();
    ...
    public void cariAnggotaArifin(String keyword){
        Anggota1841720128Arifin anggota = new Anggota1841720128Arifin().getByIdArifin(Integer.parseInt(keyword));
        jLabel6.setText("Nama Anggota : "+anggota.getNamaArifin());
    }
    
    public void cariBukuArifin(String keyword){
        Buku1841720128Arifin buku = new Buku1841720128Arifin().getByIdArifin(Integer.parseInt(keyword));
        jLabel7.setText("Judul Buku : "+buku.getJudulArifin());
    }
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        Peminjaman1841720128Arifin pmj = new Peminjaman1841720128Arifin();
        pmj.setIdpeminjamanArifin(Integer.parseInt(txtIdPeminjaman.getText()));
        
        Anggota1841720128Arifin anggota = new Anggota1841720128Arifin().getByIdArifin(Integer.parseInt(txtIdAnggota.getText()));
        Buku1841720128Arifin buku = new Buku1841720128Arifin().getByIdArifin(Integer.parseInt(txtIdBuku.getText()));
        
        pmj.setAnggotaArifin(anggota);
        pmj.setBukuArifin(buku);
        pmj.setTanggalpinjamArifin(txtTanggalPinjam.getText());
        pmj.setTanggalkembaliArifin(txtTanggalKembali.getText());
        pmj.saveArifin();
        txtIdPeminjaman.setText(Integer.toString(pmj.getIdpeminjamanArifin()));
        tampilkanDataArifin();
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        Peminjaman1841720128Arifin pmj = new Peminjaman1841720128Arifin().getByIdArifin(Integer.parseInt(model.getValueAt(row, 0).toString()));
        pmj.deleteArifin();
        kosongkanFormArifin();
        tampilkanDataArifin();
    ...
    private void btnCariAnggotaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCariAnggotaActionPerformed
        cariAnggotaArifin(txtIdAnggota.getText());
    ...
    private void btnCariBukuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCariBukuActionPerformed
        cariBukuArifin(txtIdBuku.getText());
    ...
    private void tblPeminjamanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblPeminjamanMouseClicked
        ...
        int row = tblPeminjaman.getSelectedRow();
        Peminjaman1841720128Arifin pmj = new Peminjaman1841720128Arifin();
        pmj = pmj.getByIdArifin(Integer.parseInt(model.getValueAt(row, 0).toString()));
        
        txtIdPeminjaman.setText(String.valueOf(pmj.getIdpeminjamanArifin()));
        txtIdAnggota.setText(String.valueOf(pmj.getAnggotaArifin().getIdAnggotaArifin()));
        jLabel6.setText("Nama Anggota : "+pmj.getAnggotaArifin().getNamaArifin());
        
        txtIdBuku.setText(String.valueOf(pmj.getBukuArifin().getIdbukuArifin()));
        jLabel7.setText("Judul Buku : "+pmj.getBukuArifin().getJudulArifin());
        
        txtTanggalPinjam.setText(pmj.getTanggalpinjamArifin());
        txtTanggalKembali.setText(pmj.getTanggalkembaliArifin());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmPeminjaman1841720128Arifin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmPeminjaman1841720128Arifin().setVisible(true);
            }
        });
    }
